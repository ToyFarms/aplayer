...
if(WIN32)
    set(OUTPUT_DIR "~/AppData/Local/aplayer/ext/audio")
else()
    set(OUTPUT_DIR "~/.local/share/aplayer/ext/audio")
endif()
...
foreach(SOURCE_FILE ${SOURCES})
    ...
    target_sources(${LIB_NAME} PRIVATE src/term/term_draw.c src/struct/ds.c src/logger.c src/ui/color.c)
